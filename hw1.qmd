...
```{r}
my_vec_double <- as.double(my_vec) # Conversion of data type
...
row_wise_scan consistently takes longer for larger values of M. The difference between row_wise_scan and col_wise_scan increases as M increases.
